...
public class Changetanks1 implements Screen {
    ...
    public Changetanks1(TankStars a){
        ...
        tinytank = new Texture(Gdx.files.internal("icons/Abrams.png"));
        ...
        banner = new Texture(Gdx.files.internal("icons/AbramsBan.png"));
...
//            }
            if(choose.contains(tmp.x,tmp.y)){
                if(tank1flag)GAME.info.setTank1(new Abrams(100,100,"Abrams"));
                if(tank2flag)GAME.info.setTank2(new Abrams(100,100,"Abrams"));
                GAME.goToPlayers();
            }
