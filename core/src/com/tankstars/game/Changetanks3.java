...
public class Changetanks3 implements Screen {
    ...
    public Changetanks3(TankStars a){
        ...
        tank = new Texture(Gdx.files.internal("helios.png"));
        menu = new Texture(Gdx.files.internal("menus/Rectangle 16.png"));
        tinytank = new Texture(Gdx.files.internal("icons/Helios.png"));
        ...
        banner = new Texture(Gdx.files.internal("icons/HeliosBan.png"));
        ...
        //tank
        sprite5.setSize(630, 500);
        sprite5.setPosition(-95,-50);
        //banner
